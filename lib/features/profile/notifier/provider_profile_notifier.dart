...
import 'package:drop_n_fresh/features/profile/model/profile_update_response.dart';
...
class ProviderProfileNotifier
    extends AutoDisposeNotifier<ProviderProfileState> {
  ...
  Future<void> saveProfilePicture() async {
    ...
    try {
      ...
      final Map<String, dynamic> response = await _apiClient.handleRequest(
        httpMethod: HttpMethod.patch,
        endpoint: ApiEndpoints.providerProfilePicture,
