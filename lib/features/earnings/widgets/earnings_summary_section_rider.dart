...
class EarningsSummarySectionRider extends ConsumerWidget {
  const EarningsSummarySectionRider({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // Only watch summary data
    final EarningsSummaryRiderModel? summary = ref.watch(
      riderEarningsProvider.select((EarningsRiderState state) => state.summary),
    );
