...
@immutable
class EarningsRiderDashboardResponse {
  final int code;
  final bool success;
  final String message;
  final EarningsSummaryRiderModel data;

  const EarningsRiderDashboardResponse({
    required this.code,
  ...
  factory EarningsRiderDashboardResponse.fromJson(Map<String, dynamic> json) {
    return EarningsRiderDashboardResponse(
      code: json['code'] as int? ?? 200,
      success: json['success'] as bool? ?? false,
      message: json['message'] as String? ?? '',
      data: EarningsSummaryRiderModel.fromJson(
  ...
  EarningsRiderDashboardResponse copyWith({
    int? code,
    bool? success,
    String? message,
    EarningsSummaryRiderModel? data,
  }) {
    return EarningsRiderDashboardResponse(
      code: code ?? this.code,
...
@immutable
class EarningsSummaryRiderModel {
  ...
  final OnboardingPolicyModel? onboardingPolicy; //  New field
  final String currency;

  const EarningsSummaryRiderModel({
  ...
  factory EarningsSummaryRiderModel.fromJson(Map<String, dynamic> json) {
    return EarningsSummaryRiderModel(
      ...
      onboardingPolicy: json['onboardingPolicy'] != null
          ? OnboardingPolicyModel.fromJson(
  ...
  EarningsSummaryRiderModel copyWith({
    num? allTimeEarnings,
    num? todayEarnings,
    ...
    OnboardingPolicyModel? onboardingPolicy,
    String? currency,
  }) {
    return EarningsSummaryRiderModel(
...
class OnboardingPolicyModel {
  ...
  factory OnboardingPolicyModel.fromJson(Map<String, dynamic> json) {
    return OnboardingPolicyModel(
  ...
  OnboardingPolicyModel copyWith({
    bool? onboarded,
