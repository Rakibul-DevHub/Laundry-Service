...
class BagCheckoutWebView extends StatefulWidget {
  final String checkoutUrl;
  final String? checkoutSessionId;
  final String? bagOrderId;

  const BagCheckoutWebView({
    super.key,
  ...
  @override
  State<BagCheckoutWebView> createState() => _BagCheckoutWebViewState();
}

class _BagCheckoutWebViewState extends State<BagCheckoutWebView> {
